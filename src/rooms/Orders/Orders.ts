...
export  class Orders{
    ...
    constructor(private orderID:number, private times:DateTimes,private tables:Tables,private menuItems:MenuItem,private staff:Staff ,private customers:Customer) {}
